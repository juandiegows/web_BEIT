<div class="">
        ...
        <div class=" flex w-[85%] items-center">
            <div class=" w-[85%]">
                <div class="w-[50%] flex-col flex">
                    ...
                    <a href="{{ $url }}" class="bg-btn-segundary px-1 py-2 flex justify-center items-center w-48 font-kanit italic rounded-3xl gap-2"> Más Información
                        <img src="/img/service/arrow_circle_right.png" class="w-7" alt="Flecha circular">
                    </a>
                </div>
            </div>
            <div class="w-52 relative">
                <div class="bg-red-400 h-80 rounded-s-[50px] relative flex justify-center items-center border">
                    <img src="{{ $url_logo }}" alt="{{ $name }} logo"         
                    class="absolute -left-36 w-[260px] max-w-max h-auto z-10">
    ...
    <section class="W-[100%] flex justify-start mb-32">
        <div class=" flex w-[85%] items-center">
            <div class="w-52 relative">
                <div class="bg-red-400 h-80 rounded-e-[50px] relative flex justify-center items-center border">
                    <img src="{{ $url_logo }}" alt="{{ $name }} logo"         
