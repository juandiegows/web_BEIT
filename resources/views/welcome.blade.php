...
<div class="flex  justify-between overflow-hidden  text-txt-primary">
    ...
    <section class="w-[60%] h-[95vh] min-h-[58rem]  relative overflow-hidden ">
        ...
        <img class="max-w-[30rem] absolute bottom-[18%] right-[10%]" src="{{ asset('img/personaje_lobo.png') }}" alt="">
        <p class="w-full translate-x-4 py-2 font-extrabold pl-[20%]  rounded-lg text-3xl  absolute bottom-0 bg-primary">SERVICIOS BEIT</p>
    </section>
...
<section class="w-[80%] my-4 ">
    <p class="w-full -translate-x-4 custom-shadow text-txt-primary   py-2 font-extrabold pr-[20%] text-right rounded-lg text-3xl   bg-primary">COMUNICADOS BEIT</p>
</section>
